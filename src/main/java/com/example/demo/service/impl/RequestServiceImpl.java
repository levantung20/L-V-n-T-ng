...
public class RequestServiceImpl implements RequestService {
    ...
    public RequestResponse insertLateSoonRequest(String userId, CreateSoonLateRequest createSoonLateRequest){
        boolean userByEmail = userRepository.existsUserByEmail(createSoonLateRequest.getReceiverEmail());
            if (!userByEmail) {
                    throw new CustomException("USER EMAIL DOES NOT EXIST");
            }
    ...
    public RequestResponse insertLeaveRequest(String userId, CreateLeaveRequest createLeaveRequest) {
        ...
        List<Request> requestList = requestRepository.findRequestByYearRequestAndRequestType(DateConvert.getCurrentYear(), RequestType.OFF);
        ...
        Request insert = requestRepository.insert(requestInsert);
        RequestResponse response = RequestConverter.convertReponseFromOff(insert, 180 - requestInsert.getNumDayOff());
        return response;
    }
    ...
    @Override
    public ListRequestResponse approveRequest(String requestId, RequestStatus status, String token) {
