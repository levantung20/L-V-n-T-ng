$(function() {
    ...
    $(".sidebar").load("./common/sidebar.html", function() {
        document.getElementById("sidebar-lastname").innerHTML = 'Hello ' + (storage.getItem("LAST_NAME").length > 3 ? storage.getItem("LAST_NAME").substring(0, 2) + "..." : storage.getItem("LAST_NAME")) + "!";
    });
